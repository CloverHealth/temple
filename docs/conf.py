# -*- coding: utf-8 -*-
#
# temple documentation build configuration file, created by
...
version = str(temple.__version__)
...
htmlhelp_basename = 'temple_namedoc'
...
latex_documents = [(
    master_doc,
    'cookiecutterrepo_name.tex', 'temple Documentation',
...
man_pages = [
    (master_doc, 'cookiecutterrepo_name', 'temple Documentation',
     [author], 1)
]
