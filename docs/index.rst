...
For more detailed docs about the temple command line interface (CLI) and python package, view the :ref:`cli` and :ref:`package` sections.

Want to create your own temple-managed project? View the :ref:`creating_templates` section.
